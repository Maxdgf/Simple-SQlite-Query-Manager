...
class SqliteQueryManagerApp(tk.Tk):
    ...
    #==========================================================================================================Functions
    def clear_query_output_field(self): self.query_result_field.delete("1.0", "end") #clearing the query result field

    #A function for grabbing a .db file from the file system using the Tkinter filedialog
        ...
        try:
            ...
            if len(self.selected_db.get()) > 0:
                if len(self.user_query.get()) > 0:
                    ...
                    cursor.execute(self.user_query.get()) #execute query
